...
Wall-Mounted Air Plants (mist on the 1st):
The airplants mounted near the kitchen need light misting twice a month. The mister is located near the watering can and plant food on the kitchen shelf. One spray into each glass globe is quite sufficient.

Kitchen Plants & Spider Plant on Reception Desk (Weekly on Monday):
These guys need to be thoroughly watered every week. The kitchen plants should be watered by filling their pots until water is visible on the surface of the soil (they are aquatic loving). The spider plant should be put in the kitchen sink and watered fully, then allowed to drain before placing back on the dish on the shelf. Both should be fertilized once a month on the first.

Succulent Collections on Coffee Tables (Water/mist on the first):
These don’t need much water, but they do need some. Mist and water thoroughly monthly, removing dead foliage and checking for mites and other critters. Mites can be killed with a solution of dish soap applied to the mite-infested area.

###RESERVING MEETING ROOMS

There are small glass whiteboards adjacent to each meeting room where reservations for upcoming times and dates can be written.
...
You can feel free to work in the adjoining couch or conference rooms as needed, though of course it is best to stay at the desk if practical. For breaks longer than like coffee or bathroom (like, lunch, for instance), there is a sign in the grey shelf area that indicates you are not here, and for people to sign in on their own. Put it out on the desk until you return. 

Hours of operation: you should be in the office by 9:30, and stay until 4:30. Feel free to come in earlier or stay later if you have your own work to do or just feel like hanging out.

###EVENTS

If we have an event in the evening, you should print out a sign (see documents in GitHub for template) and put it on the message board, letting members know that there is an event and the times and if it is open to the public/members or if it is private.

Check with the organizer (Carter, Ryan or Autumn) to see if they need help with anything (trash bins put out, desks moved, etc.)

Organizers should arrange with cleaning folks (currently Emma) 48 hours in advance if they are going to need help cleaning up or reseting the space after an evening event.
...
There is an office iPhone that is filled with music for the space during the day. The playlist is long and is intended to be played on random during business hours to make the space feel less like a quiet library. That being said, the volume should still be low. Turn on the music when you arrive in the morning.
...
Anyone can borrow or use the books in the tech library (over by the coffee bar) on an honor system basis. Current contents are:

* Clean Code
* jQuery Cookbook
* Design Patterns
* Backbone.js Testing (2 copies)
* Maintainable JavaScript (2 copies)
* High Performance Websites
* JavaScript Enlightenment
* Even Faster Websites
* Testable JavaScript (2 copies)
...
The Open Device Lab in located in the grey lockers. There are brochures on the outside of the locker that explain how it works. The key for the lock (if it is locked) is located in the grey storage cubby where all of the keys are. If you have questions or concerns, or members do, contact Alan (his contact info is at the end of this document).
...
If we just need general additional stuff like half & half or sugar, send an email to Autumn (see key contacts below) and let her know we're out.
